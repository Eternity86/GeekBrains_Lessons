...
public class Main {
    ...
    public static void userShot(char sign, int i) {
        int x = -1;
        int y = -1;
        do {
            if (i == 0) {
    ...
    public static void aiShot() {
        ...
        field[x][y] = AI_SIGN;
        System.out.println("x = " + (x + 1) + "| y = " + (y + 1) + "| ai_win = " + ai_win + "| user_win = " + user_win);
    }
