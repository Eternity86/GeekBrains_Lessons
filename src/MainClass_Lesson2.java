...
public class MainClass_Lesson2 {
    public static void main(String[] args) {
        ...
        /* 8. ***** Создать матрицу размерностью m*n (m должно быть нечётным, иначе спираль не закроется)
         и заполнить её по спирали числами от 1 до (m*n) с шагом 1, начиная с крайнего верхнего левого положения (0, 0)*/
        int m8 = 5;
        int n8 = 7;
